...
StdPeriph_Driver/src/%.o: ../StdPeriph_Driver/src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -DSTM32 -DSTM32F4 -DSTM32F401CCUx -DDEBUG -DSTM32F401xx -DUSE_STDPERIPH_DRIVER -I"E:/embded/Tasks/Task3/StdPeriph_Driver/inc" -I"E:/embded/Tasks/Task3/inc" -I"E:/embded/Tasks/Task3/CMSIS/device" -I"E:/embded/Tasks/Task3/CMSIS/core" -O0 -g3 -Wall -fmessage-length=0 -ffunction-sections -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
